...
export const mockRentalRecords: RentalRecord[] = [
  {
    ...
    bookingRouteName: '初级体验墙',
    bookingDate: now.toISOString().split('T')[0],
    bookingTimeRange: '10:00-11:00',
    quantity: 1,
    price: 30,
    deposit: 200,
    status: 'rented',
  ...
  },
  {
    ...
    bookingRouteName: '高手挑战墙',
    bookingDate: new Date(now.getTime() - 86400000).toISOString().split('T')[0],
    bookingTimeRange: '16:00-17:00',
    quantity: 2,
    price: 10,
    deposit: 0,
    status: 'returned',
    statusText: '到店归还',
    returnSource: 'checkin_return',
  ...
  },
  {
    ...
    bookingTimeRange: '11:00-12:00',
    quantity: 1,
    price: 15,
    deposit: 100,
    status: 'cancelled',
    statusText: '取消释放',
    returnSource: 'booking_cancel',
